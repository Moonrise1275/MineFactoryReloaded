...
import powercrystals.minefactoryreloaded.render.entity.RenderPinkSlime;
...
public class MineFactoryReloadedClient implements IScheduledTickHandler
{
	...
	public static void init()
	{
		...
		VillagerRegistry.instance().registerVillagerSkin(MFRConfig.zoolologistEntityId.getInt(), MineFactoryReloadedCore.getVillagerTexture("zoologist.png"));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityPinkSlime.class, new RenderPinkSlime());
